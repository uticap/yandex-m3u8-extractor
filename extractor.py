# Create the main extractor script
...
def extract_from_yandex(url):
    ...
    try:
        ...
        if 'yadi.sk' in url:
            ...
            print("❌ Not a valid Yandex.Disk URL")
            return []
...
def main():
    if len(sys.argv) < 2:
        print("📖 Usage: python extractor.py <yandex_url>")
        print("📝 Example: python extractor.py https://yadi.sk/d/abc123")
        print("\n📌 The URL should be a public Yandex.Disk link")
        sys.exit(1)
    ...
    if videos:
        ...
        print(f"\n✨ Done! You can now use playlist.m3u8 in your video player")
    else:
        print("\n❌ No videos found")
